...
public class RoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Room room = (Room) getIntent().getSerializableExtra("Phòng");
        position = getIntent().getIntExtra("Vị trí", -1);
    ...
    private void saveRoom() {
        ...
        resultIntent.putExtra("Phòng", room);
        resultIntent.putExtra("Vị trí", position);
